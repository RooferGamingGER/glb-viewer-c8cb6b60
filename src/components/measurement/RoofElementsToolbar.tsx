          ...
          <AccordionContent className="bg-white">
            <SidebarGroupContent>
              <SidebarMenu>
                ...
                <SidebarMenuItem>
                  <SidebarMenuButton isActive={activeMode === 'chimney'} onClick={() => selectTool('chimney')} tooltip={activeMode === 'chimney' ? "Kaminausschnitt deaktivieren" : "Kamin platzieren"} disabled={!!editMeasurementId}>
                    <Home />
                    <span>Kamin</span>
                  </SidebarMenuButton>
                </SidebarMenuItem>
